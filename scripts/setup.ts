...
// Ebsi did identity provider
import { EbsiPlugin } from '../src/agent/ebsi-plugin'
...
export const agent = createAgent<
  IDIDManager & IKeyManager & IDataStore & IDataStoreORM & IResolver & ICredentialPlugin & IEbsiPlugin
>({
  plugins: [
    new KeyManager({
